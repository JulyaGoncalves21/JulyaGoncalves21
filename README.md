...
- Business-first problem framing across commercial, technical and operational contexts
- KPI, process and decision-support routines built around stakeholder needs
- Data analysis and automation that reduce friction in day-to-day work
- Lean Thinking, Kaizen and PDCA applied to continuous improvement
- Clear communication across internal teams, dealerships, partners and leadership

## Professional background

- **Commercial Operations / Used Trucks** · Mar 2026–Present — Analytics, automation, KPI routines and process visibility.
- **Strategic Marketing & Sales Engineering** · Jun 2024–Mar 2026 — Dashboards, CRM and lead analysis, NPS, automation, cost monitoring, Lean initiatives and project coordination.
- **B2B Communication** · Jul 2024–Dec 2025 — Client relationships, commercial proposals, digital campaigns and project routines.
- **Sales Support** · May 2023–Jun 2024 — Dealer support in Brazil and support for Latin American export routines.

## Business and digital toolkit

| Business & transformation | Data & analytics | Automation | Continuous improvement |
| --- | --- | --- | --- |
| Commercial strategy | Power BI | Python | Lean Thinking |
| Stakeholder management | Power Query | Power Apps | Kaizen |
| Project coordination | Excel | Power Automate | PDCA |
| Process mapping | CRM & lead analysis | VBA | Process standardization |
...
Portuguese — native · English — fluent (C2) · Spanish — intermediate (B1)

## Connect

[Professional portfolio](https://julyagoncalves21.github.io/) · [LinkedIn](https://www.linkedin.com/in/julya-gon%C3%A7alves/)
...
Minha experiência conecta suporte a vendas, marketing estratégico e engenharia de vendas, operações comerciais e comunicação B2B. Trabalho com Power BI, Power Query, Excel, Python, Power Apps, Power Automate, VBA, CRM, Lean Thinking, Kaizen e PDCA — sempre com tecnologia como meio para melhorar o negócio.

Veja o [portfólio bilíngue](https://julyagoncalves21.github.io/) e os estudos de caso acima para conhecer minha abordagem.
